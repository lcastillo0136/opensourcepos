...
<div id="title_bar">
	...
	<div id="new_button" class="text-right">
		{form_button([
					...
					"data-toggle" => "modal",
					"data-target" => "#myModal",
					"data-title" => $this->lang->line($controller_name|cat: "_basic_information") 
				], 
		...
		{if ($controller_name =='customers')}
			...
			{anchor("$controller_name/excel/", 'Download Excel', [
					'class' => 'btn btn-info',
					'title'=>'Export Items from Table'
				])
			}
		{/if}
	</div>
...
<div id="table_action_header">
	<ul>
		<li class="pull-left disabled">
			<span>{anchor("$controller_name/delete", $this->lang->line("common_delete"), ['class'=>'btn btn-info disabled','id'=>'delete'])}</span>
		</li>
		<li class="pull-left">
			<span>{anchor("#", $this->lang->line("common_email"), ['class'=>'btn btn-info disabled','id'=>'email'])}</span>
		</li>
		<li class="pull-right">
