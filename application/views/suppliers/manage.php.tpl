...
<div id="title_bar">
	<div id="title">{$this->lang->line('common_list_of')} {$this->lang->line('module_'|cat:$controller_name)}</div>
	<div id="new_button" class="text-right">
        ...
        "data-toggle" => "modal",
        "data-target" => "#myModal",
        "data-title" => $this->lang->line("suppliers_basic_information")
      ], 
...
<div id="table_action_header">
	<ul>
		...
		<li class="float_left">
			<span><a href="#" id="email" class="btn btn-info disabled">{$this->lang->line("common_email")}</a></span>
		</li>
